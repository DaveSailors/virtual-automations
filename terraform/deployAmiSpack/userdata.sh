...
echo "***********************************" >>/tmp/userdata.log 2>&1
echo "***********************************" >>/tmp/userdata.log 2>&1
sudo yum -y install gcc.noarch >>/tmp/userdata.log 2>&1
echo "***********************************" >>/tmp/userdata.log 2>&1
echo "***********************************" >>/tmp/userdata.log 2>&1
...
echo "***********************************" >>/tmp/userdata.log 2>&1
sudo /opt/spack/spack/bin/spack help -a >>/tmp/userdata.log 2>&1
echo "***********************************" >>/tmp/userdata.log 2>&1
sudo /opt/spack/spack/bin/spack install vim  >>/tmp/userdata.log 2>&1
echo "***********************************" >>/tmp/userdata.log 2>&1
echo "***********************************" >>/tmp/userdata.log 2>&1
date >>/tmp/userdata.log 2>&1
